...
const uint32_t EMISSION_SPEED_FACTOR                         = 20;   //Need to change from 20 to decrease Block reward
...
const char     GENESIS_COINBASE_TX_HEX[]                     = "011901ff0001808090bbbad6adf00d0245886ba9b392b86da4d3c27811efe9480e9c1d6c1b173c831bea9c3293278203210187882ee5651b4ab177bf37dd00300fa2015e8c1f050f8e8f54699c05a662348e";
...
const uint64_t MINIMUM_FEE                                   = UINT64_C(100000000); // 0.0001  changed to 1.0 to COST Spammers Dearly
...
const char     CRYPTONOTE_NAME[]                             = "CarDashIan";
...
const int      P2P_DEFAULT_PORT                              =  19912;
const int      RPC_DEFAULT_PORT                              =  19913;
const int      SERVICE_DEFAULT_PORT                          =  9966;
...
{
    {  0x55, 0x11, 0x77, 0x14, 0x15, 0x17, 0x55, 0x22, 0x71, 0x8e, 0x3c, 0x66, 0x23, 0x77, 0x35, 0x21  }
};

const char* const SEED_NODES[] = {
    "13.52.68.189:19912", // Node 1
  "207.180.230.72:19912", // Node 2
};
} 
